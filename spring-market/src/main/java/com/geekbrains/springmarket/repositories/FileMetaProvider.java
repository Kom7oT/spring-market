...
import com.geekbrains.springmarket.entites.FileMetaDTO;
import com.geekbrains.springmarket.repositories.interfaces.IFileMetaProvider;
...
public class FileMetaProvider implements IFileMetaProvider {
    ...
    private static final String GET_FILES_META = "select hash, filename from spring_market.file_info_metadata where sub_type = :subtype";

    private static final String GET_FILE_PATH_BY_HASH = "select filename from spring_market.file_info_metadata where hash = :hash";

    private static final String SAVE_FILE_META_DATA = "insert into spring_market.file_info_metadata (hash, filename, sub_type)\n" +
